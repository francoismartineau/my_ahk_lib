...
class MidiOut
{
  ...
  __new(devID=-1)
    ...
    startSong()
    {
      this.channel[this.defaultChannel].startSong()
    }  
    continueSong()
    {
      this.channel[this.defaultChannel].continueSong()
    }
    stopSong()
    {
      this.channel[this.defaultChannel].stopSong()
    }
    ...
    class MidiOutChannel
    {
        ...
        startSong()
        {
            return this._midiOut._message(0xfa)
        }
        continueSong()
        {
            return this._midiOut._message(0xfb)
        }        
        stopSong()
        {
            return this._midiOut._message(0xfc)
        }        
